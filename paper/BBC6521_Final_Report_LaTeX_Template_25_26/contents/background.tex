...
\begin{table}[h]
  ...
  \footnotesize
    ...
    \hline
    \textbf{Feature} & \textbf{WirelessAgent}\newline\cite{tong2025wirelessagent} & \textbf{CommLLM}~\cite{jiang2024commllm} & \textbf{Qu et al.}~\cite{qu2025dualloop} & \textbf{This Research} \\
    \hline
